...
const TEXT = {
  ar: {
    ...
    "packages.pc": "PC",
    "packages.pc_1h": "20 جنيه / ساعة",
    "packages.ps": "PlayStation",
    "packages.ps4_single": "PS4: 30 جنيه / ساعة (فردي)",
    "packages.ps4_multi": "PS4: 40 جنيه / ساعة (متعدد)",
    "packages.ps5_single": "PS5: 40 جنيه / ساعة (فردي)",
    "packages.ps5_multi": "PS5: 50 جنيه / ساعة (متعدد)",
    "offers.title": "العروض",
    "offers.item1": "عرض الفتحة الواحدة: 7 ساعات بـ 100 جنيه",
    "offers.item2": "عرض 20 ساعة بـ 300 جنيه (صالح طوال الشهر)",
    "menu.title": "المنيو",
  ...
  en: {
    ...
    "packages.pc": "PC",
    "packages.pc_1h": "20 EGP / hour",
    "packages.ps": "PlayStation",
    "packages.ps4_single": "PS4: 30 EGP / hour (Single)",
    "packages.ps4_multi": "PS4: 40 EGP / hour (Multi)",
    "packages.ps5_single": "PS5: 40 EGP / hour (Single)",
    "packages.ps5_multi": "PS5: 50 EGP / hour (Multi)",
    "offers.title": "Offers",
    "offers.item1": "Single Station Offer: 7 Hours for 100 EGP",
    "offers.item2": "20 Hours for 300 EGP (Valid All Month)",
    "menu.title": "Menu",
